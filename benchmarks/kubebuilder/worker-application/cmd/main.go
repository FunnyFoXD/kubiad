...
import (
	...
	"github.com/FunnyFoXD/kubiad/benchmarks/kubebuilder/worker-application/internal/controller"
)
...
func main() {
	...
	if err := (&controller.WorkerApplicationReconciler{Client: manager.GetClient(), Scheme: manager.GetScheme()}).SetupWithManager(manager); err != nil {
