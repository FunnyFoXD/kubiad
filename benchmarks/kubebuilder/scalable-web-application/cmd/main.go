...
import (
	...
	"github.com/FunnyFoXD/kubiad/benchmarks/kubebuilder/scalable-web-application/internal/controller"
)
...
func main() {
	...
	if err := (&controller.ScalableWebApplicationReconciler{Client: manager.GetClient(), Scheme: manager.GetScheme()}).SetupWithManager(manager); err != nil {
